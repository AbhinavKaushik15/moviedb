    ...
    >
      <nav className="w-full h-14 flex items-center gap-[3.3vw] py-[3.5vw]">
        <Link to="/" onClick={() => navigate(-1)}>
          <IoMdArrowRoundBack className="text-[2.35vw] hover:text-purple-400" />
        </Link>
        ...
        >
          <SiWikidata className="text-[2.5vw] hover:text-purple-400" />
        </a>
        <a
          target="_blank"
          href={`https://www.imdb.com/title/${info.externalId.imdb_id}/`}
        >
          <FaImdb className="text-[2vw] text-yellow-400 hover:text-purple-400" />
        </a>
      </nav>
      ...
      <div className="hero_Section w-full flex justify-between">
        ...
        <div className="flex w-[60vw] flex-col gap-[0.9vw]">
          ...
          <p className="text-zinc-400 text-[1.2vw] w-[75%]">
      ...
      <div className="season mt-[2.2vw]">
        <h1 className="text-[2.3vw] font-[700] mb-[0.5vw]">Seasons</h1>
        <TrendingHorizontal
          data={
            info.detail.seasons.length > 0 ? (
              info.detail.seasons
            ) : (
              <h1 className="text-[3vw]">Nothing to watch.</h1>
            )
          }
        />
      </div>

      <div className="recommendations md:mt-[1vw]">
        <h1 className="text-[2.3vw] font-[700] mb-[0.5vw]">
