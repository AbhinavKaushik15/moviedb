      ...
      <div className="fixed w-full sm:w-[81.45vw] h-[9vh] sm:h-[13vh] flex items-center">
        <div className="flex items-center justify-center gap-3 mx-auto">
          ...
          <input
            ...
            value={query}
            className="bg-transparent border-zinc-400 border-[0.5px] rounded-full outline-none py-[1vw] px-[2vw] w-[38vh] sm:w-[45vw] placeholder:text-zinc-400 text-white sm:placeholder:text-[1.5vw]"
            type="text"
            placeholder="Search..."
          />
